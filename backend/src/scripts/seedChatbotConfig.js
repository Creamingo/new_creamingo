...
// First 6 intents match the welcome quick-reply buttons (exact label in keywords for button clicks).
// Phase 3: Per-flow reply copy (Contact Support, Track Order, Offers & Wallet, Delivery Info, Custom Cake, Refund/Return).
const INTENTS = [
  { name: 'Browse Cakes', keywords: ['browse cakes', 'browse', 'cakes', 'catalog', 'products', 'menu cakes'], reply: 'Browse our cakes and desserts by category – flavour, occasion, eggless, and more. Pick a slot and get same-day delivery in many areas.', link_text: 'Browse Cakes', link_href: '/products', quick_replies: null, sort_order: 0 },
  { name: 'Track Order', keywords: ['track order', 'track my order', 'order status', 'where is my order', 'tracking'], reply: 'Please share your Order ID to check the status.', link_text: 'Track Order', link_href: '/orders', quick_replies: null, sort_order: 1 },
  { name: 'Offers & Wallet', keywords: ['offers & wallet', 'offers and wallet', 'offers', 'wallet', 'cashback', 'signup', 'sign up', 'welcome bonus', 'discount', 'promo'], reply: 'Sign up & get wallet cashback up to ₹100 🎉 You can check wallet balance in your profile after login.', link_text: 'Wallet & offers', link_href: '/wallet', quick_replies: null, sort_order: 2 },
  { name: 'Delivery Info', keywords: ['delivery info', 'delivery', 'delivery time', 'delivery charges', 'when will i get', 'same day'], reply: 'Same-day delivery available in selected cities. Choose your preferred time slot at checkout.', link_text: 'FAQ', link_href: '/faq', quick_replies: null, sort_order: 3 },
  { name: 'Custom Cake', keywords: ['custom cake', 'custom', 'photo cake', 'customize cake', 'personalised', 'personalized'], reply: 'You can order custom/photo cakes from our product pages. Need a specific design? Tell us what you need.', link_text: 'Browse Cakes', link_href: '/products', quick_replies: null, sort_order: 4 },
  { name: 'Contact Support', keywords: ['contact support', 'contact', 'call', 'phone', 'speak to human', 'support', 'help', 'raise ticket'], reply: "I'm here to help you with any issue 😊 Please tell me what issue you're facing.", link_text: 'Contact', link_href: '/contact', quick_replies: null, sort_order: 5 },
  { name: 'Menu', keywords: ['menu', 'options', 'what can you do', 'what do you do', 'help me', 'how can you help'], reply: "Here's what I can help with:\n\n• **Browse Cakes** – See our cakes & desserts\n• **Track Order** – Check order status\n• **Offers & Wallet** – Cashback & wallet\n• **Delivery Info** – Timings & slots\n• **Custom Cake** – Personalised cakes\n• **Contact Support** – We're here to help\n\nTap an option below 👇", link_text: null, link_href: null, quick_replies: ['Browse Cakes', 'Track Order', 'Offers & Wallet', 'Delivery Info', 'Custom Cake', 'Contact Support'], sort_order: 6 },
  { name: 'Cancel Order', keywords: ['cancel', 'cancel order'], reply: 'You can cancel within 1 hour from your account. After that, please contact support. Once the order is prepared or out for delivery, cancellation may not be possible.', link_text: 'My Orders', link_href: '/orders', quick_replies: null, sort_order: 7 },
  { name: 'Refund / Return', keywords: ['refund', 'return', 'refund policy', 'return product', 'cancel order', 'return order', 'perishable'], reply: 'Cakes are perishable items and cannot be returned or refunded. We follow open delivery—please check the cake before accepting the order.', link_text: null, link_href: null, quick_replies: null, sort_order: 8 },
  { name: 'FAQ', keywords: ['faq', 'frequently asked', 'questions'], reply: 'We have a full FAQ on delivery, orders, payments, refunds, wallet, and more.', link_text: 'View FAQ', link_href: '/faq', quick_replies: null, sort_order: 9 },
  { name: 'Midnight Wish', keywords: ['midnight wish', 'wish', 'fulfill wish'], reply: 'Midnight Wish lets you create or fulfill surprise cake wishes. Create a wish or fulfill someone else\'s from our Midnight Wish section.', link_text: 'Midnight Wish', link_href: '/midnight-wish', quick_replies: null, sort_order: 10 },
